...
!function(t, e) {
            ...
            return a(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if ("square" === i.shape) {
                        ...
                        "circle" !== i.shape && i.shape || (g.isNumber(e) || (a = 0, e = 0), s = this.drawCircle(a, {
                            cx: t,
                            cy: e,
                            class: i.class ? i.class : "",
                            stroke: i.pointStrokeColor,
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    if (c.enabled && !m) {
                        ...
                        if ("vertical" === d.config.plotOptions.bar.dataLabels.orientation && ("top" === w && (c.textAnchor = y ? "end" : "start"), "center" === w && (c.textAnchor = "middle"), "bottom" === w && (c.textAnchor = y ? "end" : "start")), this.barCtx.isTimelineBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels)
            ...
            return o(i, t), a(i, [{
                ...
                value: function(t) {
                    ...
                    if (void 0 === n.config.tooltip.x.formatter)
                        ...
                        f = n.config.tooltip.x.formatter(o), p = n.config.tooltip.x.formatter(l);
                    return {
                        start: o,
                        end: l,
                        startVal: f,
                    ...
                    for (var o = 0; o < t[r].data.length; o++) {
                        ...
                        if (l || c)
                            if (l || i.xaxis.convertedCatToNumeric) {
                                ...
                                "datetime" === i.xaxis.type ? this.twoDSeriesX.push(s.parseDate(t[r].data[o].x.toString())) : (a.dataFormatXNumeric = !0, a.isXNumeric = !0, this.twoDSeriesX.push(parseFloat(t[r].data[o].x)));
                        else
                            h ? (this.fallbackToCategory = !0, this.twoDSeriesX.push(t[r].data[o].x)) : (a.isXNumeric = !0, a.dataFormatXNumeric = !0, this.twoDSeriesX.push(t[r].data[o].x))
                    }
                ...
                value: function() {
                    ...
                    if (t.isXNumeric && function() {
                        ...
                        if (void 0 === e.xaxis.tickAmount ? (a = Math.round(t.svgWidth / 150), "numeric" === e.xaxis.type && t.dataPoints < 30 && (a = t.dataPoints - 1), a > t.dataPoints && 0 !== t.dataPoints && (a = t.dataPoints - 1)) : "dataPoints" === e.xaxis.tickAmount ? (t.series.length > 1 && (a = t.series[t.maxValsInArrayIndex].length - 1), t.isXNumeric && (a = t.maxX - t.minX - 1)) : a = e.xaxis.tickAmount, t.xTickAmount = a, void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (t.maxX = e.xaxis.max), void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minX = e.xaxis.min), void 0 !== e.xaxis.range && (t.minX = t.maxX - e.xaxis.range), t.minX !== Number.MAX_VALUE && t.maxX !== -Number.MAX_VALUE)
                            ...
                            t.xAxisScale = this.scales.linearScale(1, a, a), t.noLabelsProvided && t.labels.length > 0 && (t.xAxisScale = this.scales.linearScale(1, t.labels.length, a - 1), t.seriesX = t.labels.slice());
        ...
        ct = function(t) {
            ...
            return o(i, t), a(i, [{
                ...
                value: function(t, e) {
                    ...
                    if (e.shiftKey ? (this.shiftWasPressed = !0, s.enableZoomPanFromToolbar("pan")) : this.shiftWasPressed && (s.enableZoomPanFromToolbar("zoom"), this.shiftWasPressed = !1), !(e.target.classList.contains("apexcharts-selection-rect") || (e.target.parentNode && e.target.parentNode.classList.contains("apexcharts-toolbar")))) {
        ...
        bt = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    if (this.clientY = l, this.clientX = o, r.globals.capturedSeriesIndex = -1, r.globals.capturedDataPointIndex = -1, l < n.top || l > n.top + n.height)
                ...
                value: function(t, e, i, a, s) {
                    ...
                    if (n.config.legend.tooltipHoverFormatter) {
                        ...
                        for (var g = 0; g < d.length; g++) {
                            ...
                            else if (u.innerHTML = f === i ? b : x, i === f)
                                break
                        }
                    }
                    if (r) {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    if (0 === n) {
                        ...
                        h.push(a + l.config.markers.offsetX), c.push(g.isNumber(e[r][n + 1]) ? s + l.config.markers.offsetY : null);
                    return {
                        x: h,
                        y: c
                    }
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    if (null === r[n][0]) {
                        ...
                        e = d.move(l, h), i = d.move(l, this.areaBottomY) + d.line(l, h);
    ...
    w = "undefined" != typeof window ? window : void 0, k = function(e, i) {
        ...
        if (a.ns = "http://www.w3.org/2000/svg", a.xmlns = "http://www.w3.org/2000/xmlns/", a.xlink = "http://www.w3.org/1999/xlink", a.svgjs = "http://svgjs.com/svgjs", a.supported = !0, !a.supported)
            return !1;
            ...
            extend: {
                ...
                parent: function(t) {
                    ...
                    if (!i.node.parentNode)
                        return null;
                    if (i = a.adopt(i.node.parentNode), !t)
                        return i;
    ...
    } : w.SVG = k(w, w.document), /*! svg.filter.js - v2.0.2 - 2016-02-24
    ...
    function() {
        ...
        function t(t, s, r, n, o, l, h) {
            for (var c = t.slice(s, r || h), d = n.slice(o, l || h), g = 0, u = {
                ...
                if (c[g] = e.call(u, c[g]), d[g] = e.call(f, d[g]), c[g][0] != d[g][0] || "M" == c[g][0] || "A" == c[g][0] && (c[g][4] != d[g][4] || c[g][5] != d[g][5]) ? (Array.prototype.splice.apply(c, [g, 1].concat(a.call(u, c[g]))), Array.prototype.splice.apply(d, [g, 1].concat(a.call(f, d[g])))) : (c[g] = i.call(u, c[g]), d[g] = i.call(f, d[g])), ++g == c.length && g == d.length)
                    break;
